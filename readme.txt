...
AV Tester is a user interaction simulator plugin for WordPress that doesn't require any special setup. Just install as simply as other plugins and start testing.
